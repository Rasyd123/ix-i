...
const Schedule = () => {
  ...
  if (currentWeek === 2 || currentWeek === 4) {
    piketGroup = [
      ["Adimas", "Kevin", "Meisyah", "Kiki", "Dewi"],
      ["Lovinia", "Sifa", "Azizah", "Reyhan", "Rafi"],
      ["Vika", "Suci", "Nazila", "Alex", "Fajar"],
      ["Rasyd", "Rizky", "Keyla", "Kezya", "Nesya"],
      ["Putra", "Abdi", "Ayu", "Aliva", "Kayla"],
      ["Farah", "Inayyah", "Galih", "Fares", "Afgan"],
    ];
